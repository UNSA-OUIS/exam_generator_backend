...
use App\Http\Controllers\ExamLayoutController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/exams/{exam}/masters', [MasterController::class, 'generate']);
    Route::delete('/exams/{exam}/masters', [MasterController::class, 'destroy']);
